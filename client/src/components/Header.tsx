    ...
    <header className="fixed top-0 w-full bg-white bg-opacity-95 shadow-sm z-50">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-xl font-bold text-dark">NoteZap</h1>
        </div>
        
        <nav className="hidden md:flex items-center space-x-8">
          <a href="#features" className="text-gray-600 hover:text-primary transition-colors duration-200">Features</a>
          <a href="#how-it-works" className="text-gray-600 hover:text-primary transition-colors duration-200">How it works</a>
          <a href="#faq" className="text-gray-600 hover:text-primary transition-colors duration-200">FAQ</a>
        </nav>
      ...
      <div className={`md:hidden ${mobileMenuVisible ? 'block' : 'hidden'}`} id="mobile-menu">
        <div className="px-4 py-3 space-y-2">
          ...
          <a href="#faq" className="block text-gray-600 hover:text-primary py-2">FAQ</a>
        </div>
      </div>
    </header>
  );

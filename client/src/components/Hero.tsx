      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col-reverse md:flex-row items-center">
          ...
          >
            ...
            >
              <span className="text-dark">Supercharge Your </span>
              <span className="text-primary">Note-Taking</span>
            </motion.h1>
            <motion.p 
              className="mt-4 text-xl text-gray-600 md:pr-12"
              variants={itemVariants}
            >
            ...
            >
              <div className="flex -space-x-2">
                ...
                <div className="w-8 h-8 rounded-full bg-gray-200 border-2 border-white flex items-center justify-center text-xs font-medium">AS</div>
                <div className="w-8 h-8 rounded-full bg-gray-200 border-2 border-white flex items-center justify-center text-xs font-medium">MK</div>
              </div>
          ...
          >
            <div className="relative w-full max-w-md">
              <div className="absolute -top-6 -right-6 w-40 h-40 bg-secondary rounded-full opacity-20 blur-3xl"></div>
              ...
              >
                <div className="bg-gray-50 py-3 px-4 border-b border-gray-100 flex items-center">
                  ...
                  <div className="ml-4 py-1 px-3 rounded-md bg-white border border-gray-200 text-xs text-gray-600 flex-grow text-center">
                ...
                <div className="p-5">
                  <div className="aspect-video bg-gray-100 rounded-lg flex items-center justify-center">
                    <div className="text-center px-4">
                      ...
                      <p className="mt-2 text-gray-400 text-sm">Extension Screenshot Placeholder</p>
                    </div>
                  </div>
                </div>
              </motion.div>
